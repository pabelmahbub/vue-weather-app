<template>
    ...
    <div style="margin: 0% 25%; background-color: azure;" v-show="modalActive"  class="absolute w-full bg-black bg-opacity-30 h-screen top-0 left-0 flex justify-center px-8">
...
<style scoped>
   ...
   .modal-outer-enter-active{
   transition: all 0.4s cubic-bezier(0.52, 0.02, 0.19, 1.02) 0.20s;
   }
